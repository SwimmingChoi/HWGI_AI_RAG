...
def main():
    ...
    end_time = time()
    print(f"✅ 정확성 채점 완료: {end_time - start_time}초")
    ...
    end_time = time()
    print(f"✅ 관련성 채점 완료: {end_time - start_time}초")
    ...
    end_time = time()
    print(f"✅ 근거성 채점 완료: {end_time - start_time}초")
    ...
    end_time = time()
    print(f"✅ 추출 관련성 채점 완료: {end_time - start_time}초")
